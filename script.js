...
// Applica animazioni solo alle sezioni tranne la galleria completa
document.querySelectorAll(".animate-fadeUp").forEach(el => {
  if (!el.closest(".gallery-wrapper")) {
    observer.observe(el);
  } else {
    // per la galleria completa rendi subito visibile
...
// ---------------------
// ATTACCO EVENTI A TUTTE LE IMMAGINI
// ---------------------
